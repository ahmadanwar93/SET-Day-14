...
function callWeatherApi(pos){
    ...
    .then(data => {
        ...
        minTempFutureDayOne.innerHTML = data.daily[1].temp.min.toFixed(1)- 273  + '&deg;C';
        maxTempFutureDayOne.innerHTML = data.daily[1].temp.max.toFixed(1)- 273 + '&deg;C';
        ...
        // asssign value to elements created
        minTempFutureDayTwo.innerHTML = data.daily[2].temp.min.toFixed(1)- 273  + '&deg;C';
        maxTempFutureDayTwo.innerHTML = data.daily[2].temp.max.toFixed(1)- 273  + '&deg;C';
        ...
        // asssign value to elements created
        minTempFutureDayThree.innerHTML = data.daily[3].temp.min.toFixed(1)- 273  + '&deg;C';
        maxTempFutureDayThree.innerHTML = data.daily[3].temp.max.toFixed(1)- 273  + '&deg;C';
        ...
        // asssign value to elements created
        minTempFutureDayFour.innerHTML = data.daily[4].temp.min.toFixed(1)- 273  + '&deg;C';
        maxTempFutureDayFour.innerHTML = data.daily[4].temp.max.toFixed(1) - 273 + '&deg;C';
        ...
        // asssign value to elements created
        minTempFutureDayFive.innerHTML = data.daily[5].temp.min.toFixed(1) - 273 + '&deg;C';
        maxTempFutureDayFive.innerHTML = data.daily[5].temp.max.toFixed(1) - 273 + '&deg;C';
